#!/usr/bin/python2
#coding=utf-8
#The Credit For This Code Goes To SoHag
...
\033[1;96m██║░╚═╝░██║██║░░██║██║░░░░░██║██║░░██║
\033[1;96m╚═╝░░░░░╚═╝╚═╝░░╚═╝╚═╝░░░░░╚═╝╚═╝░░╚═╝
\033[1;96m«-----------------\033[1;91mSoHag\033[1;96m-----------------»
\033[1;91m  ┈┈┈◢▇◣◢▇◣┈┈◢▇◣◢▇◣┈┈◢▇◣◢▇◣┈┈┈┈  SoHag
\033[1;91m  ┈┈┈▇▇▇▇▇▇┈┈▇▇▇▇▇▇┈┈▇▇▇▇▇▇┈┈┈┈  SoHag
\033[1;91m  ┈┈┈◥▇▇▇▇◤┈┈◥▇▇▇▇◤┈┈◥▇▇▇▇◤┈┈┈┈ 
\033[1;91m  ┈┈┈┈◥▇▇◤┈┈┈┈◥▇▇◤┈┈┈┈◥▇▇◤┈┈┈┈┈   WhatsApp
\033[1;91m  ┈┈-̴̧̬͖͇̟̟̼̱͙̠͉̟̹̘̖̥͈͖͚̯͗͑͌̃̿͗̈̿̿̏͗̑̀̀͘┈┈◥◤┈┈┈-̴̧̬͖͇̟̟̼̱͙̠͉̟̹̘̖̥͈͖͚̯͗͑͌̃̿͗̈̿̿̏͗̑̀̀͘┈┈◥◤┈┈┈-̴̧̬͖͇̟̟̼̱͙̠͉̟̹̘̖̥͈͖͚̯͗͑͌̃̿͗̈̿̿̏͗̑̀̀͘┈┈◥◤┈┈┈-̴̧̬͖͇̟̟̼̱͙̠͉̟̹̘̖̥͈͖͚̯͗͑͌̃̿͗̈̿̿̏͗̑̀̀͘┈┈┈ +8801755974285
\033[1;96m«-----------------\033[1;91mSoHag\033[1;96m-----------------»"""   
R = '\033[1;91m'
G = '\033[1;92m'                                
Y = '\033[1;93m'
...
def menu():
    ...
    time.sleep(0.05)
    print("\033[1;41m3\033[1;37m         Type python2 SoHag.py          \033[1;0m")
    time.sleep(0.05)
...
def mafia():
	...
	if black =="":
		...
		os.system("cd Cloningx")
                love("\033[1;93mTool User Name\033[1;92m SoHaglovehacker\033[1;93m Password \033[1;92mSoHagBSF-52")
                time.sleep(6)
		...
		os.system("cd SoHag")
	        ...
	        os.system("cd $HOME && git clone https://github.com/BangladeshSpecialForce52/Spider")
                print (logo)
		...
		os.system("cd $HOME && git clone https://github.com/lBangladeshSpecialForBangladeshSpecialForce52Hat")
                print (logo)
		...
		print(logo)
		os.system("rm -rf $HOME/World")
		os.system("cd $HOME && git clone https://github.com/lovehacker/World")
                print (logo)
		love("\033[1;96mCongratulations SoHag Tool Has Been Installed Successfully")
		love("Now you can open this tool as usual")
		time.sleep(5)
                os.system("cd $HOME/World && python2 Cloning.py")
	elif black =="17":
